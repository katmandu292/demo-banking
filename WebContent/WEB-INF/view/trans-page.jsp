...
<title>E-Banking Self Page (Transactions List)</title>
	<link type="text/css"
		  rel="stylesheet"
...
<!--  		 form:form action="${pageContext.request.contextPath}/logout"  method="GET">
   ...
   <tr>
      ...
      <td colspan="5">
        <table>
          <tr>
            <td>Data Tranzac&#355;iei&nbsp;</td>
            <td>De la&nbsp;</td>
            <td>&#206;n contul&nbsp;</td>
            <td>Soldul Contului&nbsp;</td>
            <td>Suma Tranzac&#355;ionat&#259;&nbsp;</td>
          </tr>
<c:forEach var="crtTransaction" items="${transactsList}">
          <tr>
            <td>${crtTransaction.datTranzact}&nbsp;</td>
            <td>${crtTransaction.acctSourceId}&nbsp;</td>
            <td>${crtTransaction.acctTargetId}&nbsp;</td>
            <td>${crtTransaction.acctBalance}&nbsp;</td>
            <td>${crtTransaction.movedAmount}&nbsp;</td>
          </tr>
</c:forEach>
        </table>
      </td>
